      ...
      <div class="mx-auto flex max-w-5xl items-center gap-3 px-4 py-3">
        ...
        <nav class="flex shrink-0 items-center gap-2 text-sm">
          ...
          <a
            ...
            class="flex h-8 w-8 items-center justify-center rounded-full bg-neutral-900 text-white transition-opacity hover:opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-gr-accent-strong"
